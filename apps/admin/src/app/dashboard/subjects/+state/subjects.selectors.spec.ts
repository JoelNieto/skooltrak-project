...
describe('Subjects Selectors', () => {
  ...
  const getSubjectsId = (it: SubjectsEntity) => it.id;
  ...
  let state: SubjectsPartialState;
  ...
  describe('Subjects Selectors', () => {
    ...
    it('getSelected() should return the selected Entity', () => {
      const result = SubjectsSelectors.getSelected(state) as SubjectsEntity;
